        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                ...
                <!-- <transition :name="alertAnimation" mode="out-in">
                    <div class="alert alert-info" v-if="show" key="info">This is some Info Extra</div>
                    <div class="alert alert-danger" v-else key="warning">This is some Warning</div>
                </transition>
                ...
                <button class="btn btn-primary" @click="addItem">Add Items</button>
                <br><br>
                <ul class="list-group">
